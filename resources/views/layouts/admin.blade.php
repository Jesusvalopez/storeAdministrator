...
<head>
    ...
    <link href="{{ asset('css/store_administrator.css') }}" rel="stylesheet">
    @yield('added-css')
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/" class="logo">
            ...
            <span class="logo-mini">Sticks</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">STICKS</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020 <a href="#">Sticks</a>.</strong> All rights reserved.
    </footer>
...
<script>
    ...
    var pusher = new Pusher('8e2dd170a86f704b8940', {
        cluster: 'us2'
    });
